...
const Forumilario = ({guardarMoneda, guardarCriptomoneda}) => {
    ...
    // Utilizar useMoneda
    // Se puede eliminar actualizarState porque no se utiliza o no se requiere en este lado
